                                                        ...
                                                        onChanged: (aadhaar) {
                                                          setState(() {
                                                            ...
                                                            encryptedText =
                                                                base64.encode(
                                                                    encryptedBytes);
                                                            aadhaarurlEncodedText =
                                                                Uri.encodeComponent(
                                                                    encryptedText);
                                                            print(
                                                                'aadhaarurlencoded $aadhaarurlEncodedText');
                                                          });
                                                        },
                                                      ),
                                                    ),
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        /*Container(
                                              ...
                                              child: TextButton(
                                                onPressed: (){
                                                  if (formKeyanother.currentState!.validate()){
                                                    getSaveFHTC(Aadhaarno.text, UidToken, Habitation, Selectscheme, BeneficiaryName.text, BeneficiaryId.text,_category, HusbandName.text, _gender);
                                                  }
                                                },
                                        ...
                                        Text(
                                            "pidresponse $pidjsonResponse"),
                                        Text(
                                            "save_response$savejsonResponse"),
                                        Text(Aadhaarno.text),
