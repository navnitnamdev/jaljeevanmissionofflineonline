...
class Villagelistzero extends StatefulWidget {
  ...
  const Villagelistzero({super.key, required this.assignedvillage});
                      ...
                      Column(
                        children: [
                                ...
                                child: Column(
                                  children: [
                                    message == "Record not found"
                                        ...
                                        : _loading==true ? CircularProgressIndicator() :Column(
                                      children: [
                                        filteredList.isEmpty
                                          ...
                                          child: Container(
                                            ...
                                            child: Column(
                                              children: [
                                                Image.asset("images/noresult.gif"),
                                                SizedBox(height: 50,),
                                                Padding(
                                                  padding: const EdgeInsets.all(8.0),
                                                  child: Text('No result found for this village\nplease check spelling and try again.', style: TextStyle(
                                                      fontWeight:
                          ...
                          Provider.of<InternetConnectionStatus>(context) ==
                              ...
                              : Column(
                            children: [
                              filteredList.isEmpty ? SizedBox() :    Center(
                                                                    ...
                                                                    .then(
                                                                      ...
                                                                      i++) {
                                                                        ...
                                                                        databaseHelperJalJeevan?.insertMasterSchmelist(Localmasterdatamoda_Scheme(
                                                                          source_type: sourceType.toString(),             schemeid: schemeidnew.toString(),
