...
class _NewTagWaterState extends State<NewTagWater> {
  ...
  final String _selectedscheme = '--Select Scheme--';
  ...
  void openCamera() async {
    try {
      ...
      final mb = kb / 1024;
      /* final img.Image oripic = Drawlatlong.drawlatlong(
          imgCamera.path,
          _currentPosition?.latitude.toString() ?? "",
          _currentPosition?.longitude.toString().toString() ?? "");*/
      if (kDebugMode) {
  ...
  final bool _loading_siblist = false;
  final bool _loading_getloc = false;
  ...
  void fetchRecordsByschemeid(schemeid) async {
    setState(() {});
    await databaseHelperJalJeevan!
        .getallrecordsib_masterdata(schemeid, widget.villageid)
        .then((value) {
      if (value.isNotEmpty) {
        setState(() {
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          const EdgeInsets.all(
                                              2.0),
                                          child: sibmasterdeail_list.isEmpty
                                              ? const SizedBox()
                                              : const Text(
                                                    ...
                                                    Container(
                                                      ...
                                                      child: SizedBox(
                                                        ...
                                                        child: btnstateicon ==
                                                          ...
                                                          onTap:
                                                              () async {
                                                            if (sibmasterdeail_list.isNotEmpty) {
                                                    ...
                                                    onPressed: () async {
                                                      try {
                                                        ...
                                                        if (result
                                                         ...
                                                         else if (ESRstoragestructuretype ==
                                                              "") {
                                                            Stylefile
                                                                .showmessageforvalidationfalse(
                                                                context,
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        MainAxisAlignment.start,
                                        children: [
                                          Listdetaillistofscheme.isEmpty
                                              ? const SizedBox()
                                              : Container(
                                            child: const Column(
                                              children: [
                                          ...
                                          Column(
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                child:
                                                localpwspendingDataList.isEmpty
                                                    ? const Center(
                                                    child: SizedBox())
                                                    : SingleChildScrollView(
                                                  child: Column(
                                                                            ...
                                                                            children: [
                                                                              SizedBox(
                                                                                ...
                                                                                child: ElevatedButton.icon(
                                                                                  ...
                                                                                  onPressed: () {
                                                                                    Get.to(ZoomImage(imgurl: localpwspendingDataList[index].image,
                                                                                    ));
                                                                                  },
                                                                                  icon: const Icon(
                                          ...
                                          Visibility(
                                              ...
                                              child: Container(
                                                child: Column(
                                                  children: [
                                                    Listdetaillistofscheme_mvs.isEmpty
                                                        ? const SizedBox()
                                                        : Container(
                                                      child: const Column(
                                                        children: [
                                                                  ...
                                                                  children: [
                                                                    SizedBox(
                                                                      ...
                                                                      ElevatedButton.icon(
                                                                        ...
                                                                        onPressed:
                                                                            () {
                                                                    Get.to(ZoomImage(imgurl:
                                                                           localsibpendinglist[index].photo,
                                                                          ));
