...
class _StoragestructurependingapprovedState
  ...
  Future StoragestructurePendingandApprovedAPI(String villageid, String stateid,
    ...
    var response = await http.get(
      Uri.parse(
          "${Apiservice.baseurl}JJM_Mobile/GetGeotaggedStorageStructure?VillageId=$villageid&StateId=$stateid&UserId=$userid&Status=$status"),
      headers: {
          ...
          child: _loading == true
            ...
            child: SizedBox(
              ...
              child: Container(
                ...
                child: ssgeotahpendingapprovelist.isEmpty
                    ? const Center(
                  child: Padding(
