...
class _VillageListScreenState extends State<VillageListScreen> {
  ...
  Future getvillagelist() async {
    ...
    final response = await http.get(
      ...
      headers: {
        ...
        //'APIKey': "38f4c5e0-6172-4490-9de3-4b07aa6b3df5"
      },
    );
    ...
    if (response.statusCode == 200) {
      ...
      if (mResposne["Message"] == "Village list") {
        ...
        for (int i = 0; i < data.length; i++) {
          ...
          listofvill
              .add(Villagelistforsend(VillageName, VillageId, OfflineStatus, PanchayatName, BlockName, DistrictName));
          ...
          if (listofvill[i].OfflineStatus == '1') {
            setState(() {
              ...
              // databaseHelperJalJeevan!.insertofflinevillagelist(saveoffinevillagemodal!);
              //  databaseHelperJalJeevan!.insertselecttvillageofflineDB(saveoffinevillagemodal!);
  ...
  insertvillagedetails(savevillagedetails) async {
    ...
    print("inservillagedetails" + savevillagedetails);
  }
  ...
  Future getschemesource(
    ...
    if (response.statusCode == 200) {
      ...
      for (int i = 0; i < data.length; i++) {
        ...
        print("scheme_category$newCategory");
      }
    ...
    try {
      var response = await http.get(
        ...
        headers: {
          'Content-Type': 'application/json',
          'APIKey': token ?? 'DEFAULT_API_KEY'
          //'APIKey': "debdefe5-c9bd-43e4-b3b4-0fdeef151d2e" ?? 'DEFAULT_API_KEY'
        },
      );
      if (response.statusCode == 200) {
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: const Text("Assigned Villages ",
            style: TextStyle(
                              ...
                              children: [
                                      ...
                                      children: [
                                        Container(
                                          child: const Column(
                                            ...
                                            children: [
                                              Text(
                                                  Textfile.headingjaljeevan,textAlign: TextAlign.justify,
                                                  style:    Stylefile.mainheadingstyle
                                              ),
                                              SizedBox(
                                                child: Text (
                                                    Textfile.subheadingjaljeevan,textAlign: TextAlign.justify,
                                ...
                                InkWell(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: const Icon(Icons.logout , size: 35, color: Appcolor.btncolor,),
                                  ),
                                ),
                                      ...
                                      child: Column(
                                        children: [
                                                                                        ...
                                                                                        child: Row(
                                                                                          ...
                                                                                          children: [
                                                                                            ...
                                                                                            IconButton(
                                                                                              color: Colors.black,
                                                                                              onPressed: () {
                                                                                                print("villageid_${listofvill[index].villageid}");
                                                                                              },
                                                                                              icon: const Icon(
                                          ...
                                          SizedBox(child: Padding(
                                            padding: const EdgeInsets.all(5.0),
                                            child: Text(sss.toString(),  style: const TextStyle(fontWeight: FontWeight.w500, fontSize: 14)),
                                          ),)
                                        ],
                                      ),
                                    ),
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  if (box.read("UserToken").toString() ==
                                    ...
                                    if (_selecteCategorys.isEmpty) {
                                    ...
                                    } else if (_selecteCategorys.isEmpty) {



                                      Stylefile.showmessageforvalidationfalse(context, "Select minimum one village");
                                    } else {
                                      SaveOfflinevilaagesApi(
                                        ...
                                        if (value["Message"].toString() ==
                                          ...
                                          print("village_of${value["Status"]}");
                                          print("valueofvillage${value["Villagelist"]}");
                                        } else {
