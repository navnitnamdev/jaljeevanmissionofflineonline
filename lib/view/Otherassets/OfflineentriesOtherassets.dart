...
class OfflineentriesOtherassets extends StatefulWidget {
  String villageid = "";
  String villagename = "";
  String stateid = "";
  String block = "";
  ...
  @override
  State<OfflineentriesOtherassets> createState() => _PWSPendingapprovalState();
}

class _PWSPendingapprovalState extends State<OfflineentriesOtherassets> {
  ...
  void initState() {
    ...
    setState(() {
      getallotherassetssavedofflineentry_villageidwise(context);
    });
  ...
  Future<void> getallotherassetssavedofflineentry_villageidwise(
    ...
    await databaseHelperJalJeevan
        ?.getallotherassetssavedofflineentry_villageidwise(widget.villageid)
        .then((value) {
      _loading = false;
      localotherassetsofflinelist = value!.toList();
        ...
        child: Scaffold(
            appBar: PreferredSize(
              ...
              child: AppBar(
                ...
                title: const Text("Geo-tagged Otherassets (Offline)",
                    style: TextStyle(
                        fontSize: 16,
                        color: Colors.white,
                      ...
                      child: Column(
                        children: [
                          _loading == true
                            ...
                            child: localotherassetsofflinelist.isEmpty
                                ? const Center(
                                child: SizedBox(
                                    child: Text(
                                      "No data found",
                                                        ...
                                                        Flexible(
                                                          ...
                                                          Padding(
                                                            ...
                                                            Text(
                                                              maxLines:
                                                              4,
                                                              localotherassetsofflinelist[index]
                                                                  .SchemeName
                                                                  .toString(),
                                                              style:
                                                              const TextStyle(
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: SizedBox(
                                                              ...
                                                              child: Text(
                                                                ...
                                                                maxLines:
                                                                10,
                                                                localotherassetsofflinelist[index].landmark.toString(),
                                                                style: const TextStyle(
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: SizedBox(
                                                              ...
                                                              child: Text(
                                                                ...
                                                                overflow:
                                                                TextOverflow.ellipsis,
                                                                localotherassetsofflinelist[index].latitude.toString(),
                                                                style: const TextStyle(
                                                                    fontWeight: FontWeight.w400,
                                                                    color: Appcolor.black,
                                                                    fontSize: 16),
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: SizedBox(
                                                              ...
                                                              child: Text(
                                                                ...
                                                                overflow:
                                                                TextOverflow.ellipsis,
                                                                localotherassetsofflinelist[index].longitude.toString().toString(),
                                                                style:
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: SizedBox(
                                                              ...
                                                              child: Text(
                                                                maxLines:
                                                                10,
                                                                localotherassetsofflinelist[index].Status.toString(),
                                                                style: const TextStyle(
                                                                    fontSize: 16,
                                                                    fontWeight: FontWeight.w400,
                                                                    color: Appcolor.red),
                                                            ...
                                                            SizedBox(
                                                              ...
                                                              ElevatedButton.icon(
                                                                ...
                                                                onPressed:
                                                                    () {
                                                                  Get.to(ZoomImage(
                                                                    imgurl: localotherassetsofflinelist[index].photo,
                                                            ...
                                                            SizedBox(
                                                              ...
                                                              ElevatedButton.icon(
                                                                ...
                                                                onPressed:
                                                                  ...
                                                                  _showAlertDialogforuntaggeoloc(localotherassetsofflinelist[index].id.toString(), index);
                                                                },
                                                                icon:
                                                                const Icon(
                                                                  size: 18.0,
  ...
  Future<void> cleartable_localmasterschemelisttable() async {
    ...
    await databaseHelperJalJeevan!.truncatetable_otmasterdeatils();
    ...
    Apiservice.Getmasterapi(context).then((value) {
      ...
      for (int i = 0; i < value.schmelist!.length; i++) {
        ...
        databaseHelperJalJeevan
          ...
          source_type: schemeidnew.toString(),
          ...
          actions: <Widget>[
            ...
            Container(
              ...
              child: TextButton(
                ...
                onPressed: () async {
                  Navigator.of(context).pop();
                  await databaseHelperJalJeevan!.clearRowByIdot(id);
                  Stylefile.showmessageforvalidationtrue(context, "Removed");
                  setState(() {
                    localotherassetsofflinelist.removeAt(index);
                  });
                },
              ),
            ),
