...
class _PWSPendingapprovalState extends State<PWSPendingapproval> {
  ...
  Future PWSPendingapprovalAPI(String villageid, String stateid, String userid,
    ...
    var response = await http.get(
      Uri.parse(
          "${Apiservice.baseurl}JJM_Mobile/GetGeotaggedWaterSource?VillageId=$villageid&StateId=$stateid&UserId=$userid&Status=$status"),
                        ...
                        children: [
                          ...
                          Visibility(
                            ...
                            child: Container(
                              ...
                              child: localpwspendingDataList.isEmpty
                                  ? const SizedBox(
