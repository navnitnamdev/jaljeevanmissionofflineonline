class Textfile{
  ...
  static String passwordlengthshouldbesix="Password length should be six characters";
  static String passwordlengthshouldbefive="Password length should be five characters";
