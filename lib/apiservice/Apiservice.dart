...
class Apiservice {
  ...
  static Future Loginapi(BuildContext context,
      String userid,
      String password,
      String randomsalt,
      ) async {
  ...
  static Future OTPVerificationapi(
          ...
          return Column(
            ...
            children: [
              SizedBox(
                  height: 40,
                  width: 40,
                  //child: Lottie.asset('images/loadereverification.json'),)
                  child: CircularProgressIndicator()),
            ],
          );
        });
  ...
  static Future<Getmasterdatamodal> Getmasterapi(BuildContext context) async {
    try {
      ...
      var uri = Uri.parse(
          "${"${Apiservice.baseurl}JJM_Mobile/Get_MasterData?&StateId=" +
